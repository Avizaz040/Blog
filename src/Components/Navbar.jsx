    ...
    >
      ...
      <div
        className={`fixed top-0 left-0 bottom-0  transition-transform duration-500 ${
          ...
          theme === "dark" ? "text-white bg-gray-800" : "text-[#333333] bg-white"
        }`}
      >
        {/* User Profile Section */}
        <div className="flex justify-between items-center">
          <CgProfile className={`w-12 h-12 text-gray-500 ${theme === "dark" ? "text-white" : "text-[#333333]"}`} />
          
          <RiCloseLargeFill
            className={`w-8 h-8 cursor-pointer text-blue-600 ${theme === "dark" ? "text-white" : "text-[#333333]"}`}
            onClick={toggleMenu}
          />
        </div>
